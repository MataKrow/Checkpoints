...
move .\BUILD.ipk3 D:\Doom\SourcePorts\GZDoom
cd D:\Doom\SourcePorts\GZDoom
start gzdoom.exe -host 7 +name Player -noautoload  +vid_fullscreen 0 +developer 2 +idmypos 1 +vid_fps 1 +am_cheat 2 +noise 0 +map NULL +sv_cheats 1 -noidle +vid_defwidth 800 +vid_defheight 450 -0 +win_x 41 +win_y 523
